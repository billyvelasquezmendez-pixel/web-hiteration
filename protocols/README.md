...
El **PROTOCOLO_KEN_ICHIJOUJI** fue reclasificado de **CORE** a **EXTENSION_POLICY_PROTOCOL** durante la auditoría WH-AUDIT-CORE-2026. Su formulación original podía interpretarse como prohibición universal. La versión actual está limitada al alcance del framework. Ver `/protocols/extensions/ken-ichijouji-policy.json`.
...
|---------|-----------|--------|
| `extensions/ken-ichijouji-policy.json` | KEN_ICHIJOUJI_POLICY | 🔄 Reclasificado |
...
**Progreso de extensiones:** 1/6 (Ken Ichijouji reclasificado)
...
El núcleo de invariantes y protocolos ha sido auditado en múltiples ciclos. Las correcciones derivadas de esas auditorías han sido integradas. Los documentos consolidados están disponibles en `/evidence/`.

**Validación experimental controlada:** PENDIENTE.
...
Ver `LICENSE.md` en la raíz del repositorio para los términos completos.| `modelo-estados.json` | MODELO_ESTADOS_S0_S4 | ✅ Publicado |
| `p-drift.json` | P_DRIFT | ✅ Publicado |
| `ken-ichijouji.json` | PROTOCOLO_KEN_ICHIJOUJI | ✅ Publicado |

**Progreso del núcleo:** 6/6 ✅ **NÚCLEO COMPLETO**

---

## Extensiones (Protocolos Experimentales)

Los siguientes protocolos son **provisionales** y no forman parte del núcleo verificable:
...
1. Reconocer la autoría original.
2. Mantener la licencia CC BY-SA 4.0.
3. Preservar las cinco invariantes del ADN lógico.

Ver `LICENSE.md` en la raíz del repositorio para los términos completos.| `modelo-estados.json` | MODELO_ESTADOS_S0_S4 | 🔄 Pendiente |
